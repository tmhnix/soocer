angular.module('todoApp')
    .directive('leftBetWait', ['$templateCache', 'leaguesAPI', function ($templateCache, leaguesAPI) {
    return {
        restrict: 'EA', //E = element, A = attribute, C = class, M = comment
        template: $templateCache.get('elements/left-bet-wait/left-bet-wait.html'),
        controller: ['$scope', '$rootScope', function ($scope, $rootScope) {
            ...
            bindEvent(window, 'message', function (e) {
                ...
                if (data.name == 'EVENT_BET_SUCCESS') {
            ...
            function startCountDown() {
                $scope.waitSetting.type = 'waitingBets';
                $scope.waitSetting.bet_number = 5;
                interval && clearInterval(interval);
