...
<body scroll="no">
    ...
    <div class="content-wrapper" id="content-wrapper">
        ...
        @include('web.portal.head')

        <main class="content search-table-outter wrapper" id="content" data-default-url="/portal/agentHome">
                @yield('content')
        </main>
