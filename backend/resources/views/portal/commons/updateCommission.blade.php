<html xmlns="http://www.w3.org/1999/xhtml"><head><meta charset="utf8">
        <title>
        ...
        <div id="page_popup">
            <table width="350px" cellpadding="0" cellspacing="1" border="0">
                <tbody>
                    <tr>
                        <td class="l">
                            <div id="header_main" style="display: none;">
                                Change Commission {{$user->username}}                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                    ...
                    <tr>
                        <td align="center">
                           {!! Form::model($user, array('route' => array('portal.web.updateCommissionPost', $user->id))) !!}
                                    ...
                                    <tr class="RptHeader">
                                        ...
                                        <tr class="bg_eb2">
                                            ...
                                            <td id="td_pass" class="l">
                                                <select id="hh" name="discountAsian">
                                                    <option value="0.0025" {{$user->discountAsian == 0.0025 ? 'selected' : ''}}>0.0025</option>
                                                    <option value="0.0020" {{$user->discountAsian == 0.0020 ? 'selected' : ''}}>0.0020</option>
                                                    <option value="0.0015" {{$user->discountAsian == 0.0015 ? 'selected' : ''}}>0.0015</option>
                                                    <option value="0.0010" {{$user->discountAsian == 0.0010 ? 'selected' : ''}}>0.0010</option>
                                                    <option value="0.0005" {{$user->discountAsian == 0.0005 ? 'selected' : ''}}>0.0005</option>
                                                    <option value="0" {{$user->discountAsian == 0 ? 'selected' : ''}}>0</option>
                                                </select>
