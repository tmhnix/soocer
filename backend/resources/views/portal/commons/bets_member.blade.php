            ...
            #header_main
{
  ...
  width: 350px;
    ...
    {!! Form::model(array('route' => array('portal.web.updateBetsMemberPost', $user->id))) !!}
    <input type="hidden" name="mb" value="{{$user->username}}">
        <div id="header_main" class="pt7">Tùy chỉnh thiết lập về tiền cược {{$user->username}}</div>
    ...
    <tr>
        ...
        <td>
          <input style="text-align: right;" name="bongdamin" class="BettingLimitTextBox" min="1" max="1000000" value="{{$user->bongdamin}}" maxlength="14" type="number" required=""> &gt;=1</td>
        <td><input style="text-align: right;" name="bongdamax" class="BettingLimitTextBox" min="1" max="1000000" value="{{$user->bongdamax}}" maxlength="14" type="number" required=""> &lt;=1000000</td>
        <td><input style="text-align: right;" name="bongdaper" class="BettingLimitTextBox" min="1" max="1000000" value="{{$user->bongdaper}}" maxlength="14" type="number" required=""> &lt;=1000000</td>
    </tr>
    <tr>
        <td>Bóng Rổ</td>
        <td><input style="text-align: right;" name="bongromin" class="BettingLimitTextBox" min="0" max="1000000" value="{{$user->bongromin}}" maxlength="14" type="number" required=""> &gt;=1</td>
        <td><input style="text-align: right;" name="bongromax" class="BettingLimitTextBox" min="0" max="1000000" value="{{$user->bongromax}}" maxlength="14" type="number" required=""> &lt;=1000000</td>
        <td><input style="text-align: right;" name="bongroper" class="BettingLimitTextBox" min="0" max="1000000" value="{{$user->bongroper}}" maxlength="14" type="number" required=""> &lt;=1000000</td>
    </tr>
    <tr>
        <td>Tennis</td>
        <td><input style="text-align: right;" name="bauducmin" class="BettingLimitTextBox" min="0" max="1000000" value="{{$user->bauducmin}}" maxlength="14" type="number" required=""> &gt;=1</td>
        <td><input style="text-align: right;" name="bauducmax" class="BettingLimitTextBox" min="0" max="1000000" value="{{$user->bauducmax}}" maxlength="14" type="number" required=""> &lt;=1000000</td>
        <td><input style="text-align: right;" name="bauducper" class="BettingLimitTextBox" min="0" max="1000000" value="{{$user->bauducper}}" maxlength="14" type="number" required=""> &lt;=1000000</td> 
    </tr>
    </tbody></table>
    </div>
  </div>
