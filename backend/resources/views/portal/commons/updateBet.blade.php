    ...
    <div id="page_popup">
        <table width="100%" cellpadding="0" cellspacing="1" border="0">
            <tbody>
                ...
                <tr>
                    <td align="center">
                        {!! Form::model(['route' => ['portal.web.updateBetPost', $id]]) !!}
                        <table width="100%" align="center" cellpadding="0" cellspacing="1" border="0"
                            ...
                            <tbody>
                                ...
                                <tr class="bg_eb2">
                                    ...
                                    <td id="td_pass" class="l">
                                        <input type="number" value="{{ $bet->bet_position }}" name="bet_position"
                                ...
                                <tr class="bg_eb2">
                                    ...
                                    <td id="td_confirmpass" class="l">
                                        <input type="number" step="any" value="{{ $bet->bet_amount }}"
                                            name="bet_amount" maxlength="10" required>
                                ...
                                <tr class="bg_eb2">
                                    ...
                                    <td id="td_confirmpass" class="l">
                                        <input type="number" step="any" value="{{ $bet->bet_value }}"
                                            name="bet_value" maxlength="10" required>
                                        <span id="spnConfirmPwdIcon">
                                            &nbsp;
                                        </span>
                                    </td>
                                ...
                                <tr class="bg_eb2">
                                    ...
                                    <td id="td_confirmpass" class="l">
                                        <input type="text" step="any" value="{{ $bet->type }}"
                                            name="type" required>
                                        <span id="spnConfirmPwdIcon">
                                            &nbsp;
                                        </span>
                                ...
                                <tr class="bg_eb2">
                                    ...
                                    <td id="td_confirmpass" class="l">
                                        <input type="text" value="{{ $bet->created_at }}" name="created_at" required>
                                        <span id="spnConfirmPwdIcon">
                                            &nbsp;
                                        </span>
                                    </td>
                                ...
                                @if (isset($bet->odd['handicap_value']))
                                    <tr class="bg_eb2">
                                        ...
                                        <td id="td_confirmpass" class="l">
                                            <input type="number" step="any" value="{{ $bet->odd['handicap_value'] }}"
                                                name="handicap_value" maxlength="10" required>
                                            <span id="spnConfirmPwdIcon">
                                                &nbsp;
                                            </span>
                                        </td>
                                ...
                                <tr class="bg_eb2">
                                    ...
                                    <td id="td_confirmpass" class="l">
                                        <input type="text" value="{{ $bet->ss }}" name="ss" maxlength="10"
                                            required>
                                        <span id="spnConfirmPwdIcon">
                                            &nbsp;
                                        </span>
                                ...
                                <tr class="bg_eb2 c">
                                    <td colspan="2">
                                        ...
                                        <input type="submit" id="btnSubmit" name="submit" value="Xác nhận"
                                            class="btn">
                                        &nbsp;
