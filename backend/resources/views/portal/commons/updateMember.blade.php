         ...
         <table width="100%" cellpadding="0" cellspacing="1" border="0">
            <tbody>
               <tr>
                  <td class="l">
                     <div id="header_main">
                        Thay đổi thông tin {{$user->username}}
                     </div>
                  </td>
               </tr>
               <tr>
               ...
               <tr>
                  <td align="center">
                    {!! Form::model($user, array('route' => array('portal.web.updateMemberPost', $id))) !!}
                     <table class="tblRpt" cellpadding="0" cellspacing="1" border="0" width="100%">
               <tbody>
                  <tr class="RptHeader">
                     <td colspan="4">
                        ...
                        <input type="hidden" name="mb" value="ZXTE2N004">
                  <tr class="bg_eb2">
                     <td class="r">
                        Họ
                     </td>
                     <td>
                        {!! Form::text('first_name', null, array('placeholder' => 'Họ','class' => 'form-control')) !!}
                     </td>
                     <td class="r">
                        Tên
                     </td>
                     <td>
                        {!! Form::text('last_name', null, array('placeholder' => 'Tên','class' => 'form-control')) !!}
                     </td>
                  </tr>
                  <tr class="bg_eb2">
                     <td class="r">
                     ...
                     <td>
                        {!! Form::text('home_mobile', null, array('placeholder' => 'Điện thoại','class' => 'form-control')) !!}
                     </td>
                     <td class="r">
                        Di động
                     </td>
                     <td>
                        {!! Form::text('phone', null, array('placeholder' => 'Di động','class' => 'form-control')) !!}
                     </td>
                  </tr>
                  <tr class="bg_eb2">
                     <td class="r">
                     ...
                     <td class="l">
                        <select name="reset">
                                <option selected="" value="0">Hằng ngày</option>
                                <option value="2">Không reset</option>
                  ...
                  <tr>
                     <td colspan="4" class="bg_eb">
                            <center>
                        <input type="submit" id="btnSubmit" value="Cập Nhật" class="btn">
                        &nbsp;
                        <input type="reset" id="btnReset" value="Reset" class="btn">
                        &nbsp;</center>
                     </td>
                  </tr>
