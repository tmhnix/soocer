        ...
        <div id="page_popup">
         <table width="100%" cellpadding="0" cellspacing="1" border="0">
            <tbody>
               ...
               <tr>
                  <td align="center">
                    {!! Form::model(array('route' => array('portal.web.usersChangePwdPost', $id))) !!}
                        ...
                        <tbody>
                           ...
                           <tr class="bg_eb2">
                              ...
                              <td id="td_pass" class="l">
                                 <input type="password" onkeydown="" id="pw" name="password" required>
                           ...
                           <tr class="bg_eb2">
                              ...
                              <td id="td_confirmpass" class="l">
                                 <input type="password" id="cpw" name="re_password" required>
