...
@section('main')
{!! Form::open(array('route' => 'portal.admin.super.createPost')) !!}
  <div class="minWidthCustomer">
    ...
    <input type="text" hidden name="username" value="<%supper.selectedOne + '' + supper.selectedTwo%>">
    <div class="customerInfo">
      ...
      <div class="clearBlock">
        ...
        <div class="customerInfoBlock2">
          <input name="first_name" required type="text" class="textBoxInfo" maxlength="50">
        </div>
        <div class="customerInfoBlock3">Họ</div>
        <div class="customerInfoBlock4">
          <input type="text" required name="last_name" class="textBoxInfo" maxlength="50">
        </div>
      </div>
      <div class="clearBlock">
      ...
      <div class="clearBlock">
        ...
        <div class="customerInfoBlock2">
          <input type="number" id="credit" max="{{$authUser->wallet}}" min=0 maxlength="14" class="textBoxCredit textBoxInfo" name="wallet" required="required">
