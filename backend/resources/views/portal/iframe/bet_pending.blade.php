...
<body onload="">
        <div id="page_main">
            <div class="bl_title">
                Danh sách cược đang treo (<span id="reloading"></span>)
            ...
            <br>
            <a class="btn btn-primary" href="/portal/bet_pending?sync_bet_pending=true">Đồng bộ kèo treo</a>
            ...
            <table id="hor-minimalist-a"
                ...
                <thead>
                    <tr>
                        ...
                        <th class="col-transtime">event_id</th>
                        <th>Lựa chọn</th>
