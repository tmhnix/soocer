...
<frameset class="body" rows="95,*,0" cols="*" framespacing="0" frameborder="no" border="0">
    ...
    <frameset rows="*" cols="198,*,0" framespacing="0" frameborder="no" border="0" id="frameset1" name="frameset1">
        <frame src="/leftIframe" name="leftFrame" scrolling="auto" id="leftFrame" noresize="noresize" style="overflow-x:hidden">
        <!-- <frame src="/underodds?ref={{$req->ref}}" name="mainFrame" id="mainFrame"> -->
    </frameset>
</frameset>
</html>