<html class="" xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <link rel="shortcut icon" href="/template/common/Images/favicon.ico?v201805101111" type="image/x-icon">
    <link href="/template/_global/common/css/account.css?v201805101111" type="text/css" rel="stylesheet">
    <link href="/template/common/css/main.css?v201805101111" type="text/css" rel="stylesheet">

    <script src="/bundles/jquery?v=gkWyJthHPtwkFjvHuNinBjchIfwLwc_KbE-H26J2kAI1"></script>

    <script src="https://cdnjs.cloudflare.com/ajax/libs/socket.io/1.4.5/socket.io.min.js"></script>
    <script src="/Scripts/react.min.js?v201805101111"></script>
	<script src="/Scripts/react-dom.min.js?v201805101111"></script>
    <script src="/bundles/Account?v=IreTJXwtazlzXs5NvJeyCCMkEim-a4m3ZASc5tarNZQ1"></script>

    <script src="/bundles/main?v=S8tdgZl4st0u1k_PNvgOK0fL2iRNdjTcNao3KDIwtBs1"></script>
...
<body>
            ...
            <div class="header-expand header-belt">
                ...
                <div class="header-belt-main">
                    <ul class="nav-main">
                        ...
                        <li class="">
                            <span class="icon-betList" onclick="location.href='/Statement/BetList'">Bảng Cược</span>
                        </li>
                        <li class="">
                            <span class="icon-statement" onclick="location.href='/AllStatement.aspx'">Sao Kê</span>
                        </li>
                        <li class="">
                            <span class="icon-result" onclick="location.href='/Result'">Kết Quả</span>
                        </li>

                                <li class="active">
                                    <span class="icon-message" onclick="location.href='/Message/MessageHistory'">Nhật Ký Tin Nhắn</span>
                                </li>

                                <li class="">
                                    <span class="icon-preferences " onclick="location.href = '/Preferences/AccountAndStatememt'">Tùy thích/Tự Chọn</span>
                                </li>
    ...
    <script type="text/javascript" src="/Scripts/jscalendar/calendar.js?v201805101111"></script>
    <script type="text/javascript" src="/Scripts/jscalendar/lang/calendar-en.js?v201805101111"></script>
    <script type="text/javascript" src="/Scripts/jscalendar/calendar-setup.js?v201805101111"></script>
    <script src="/Scripts/react.min.js?v201805101111"></script>
	<script src="/Scripts/react-dom.min.js?v201805101111"></script>
    <script>
        function sDateChanged(calendar) {
            if (calendar.dateClicked) {
                var y = calendar.date.getFullYear();
                var m = calendar.date.getMonth(); // integer, 0..11
                var d = padLeft(calendar.date.getDate(), 2); // integer, 1..31
                var selob = document.getElementById("selsDate");
                selob.innerHTML = (m + 1) + "/" + d + "/" + y;
                $("#sDate").val((m + 1) + "/" + d + "/" + y);
                $("#MessageContainer").html("<div class='preloader' data-tag='tagPreloader'><div class='spin'></div></div>");
                document.formMessageHistory.submit();
            }
        }

        function eDateChanged(calendar) {
            if (calendar.dateClicked) {
                var y = calendar.date.getFullYear();
                var m = calendar.date.getMonth(); // integer, 0..11
                var d = padLeft(calendar.date.getDate(), 2); // integer, 1..31
                var selob = document.getElementById("seleDate");
                selob.innerHTML = (m + 1) + "/" + d + "/" + y;
                $("#eDate").val((m + 1) + "/" + d + "/" + y);
                $("#MessageContainer").html("<div class='preloader' data-tag='tagPreloader'><div class='spin'></div></div>");
                document.formMessageHistory.submit();
        ...
        function SelectChange(type) {
            $("#SelectMsgType").val(type);
            $("#MessageContainer").html("<div class='preloader' data-tag='tagPreloader'><div class='spin'></div></div>");
            document.formMessageHistory.submit();

            //$.ajax({
            //    type: "POST",
            //    data: "SelectMsgType=" + type,
            //    url: '/Message/MessageHistory',
    ...
    <form name="formMessageHistory" method="post" action="/Message/MessageHistory">
        <input id="sDate" type="hidden" value="5/8/20120" name="sDate">
        <input id="eDate" type="hidden" value="9/8/2021" name="eDate">
            ...
            <div class="filterBlock ">
                <div class="filterRow">
                    <div id="f_trigger_a" class="filter dropdown-Date">
                        <div class="selected">
                            <span class="txt" id="selsDate">8/7/2020</span>
                    ...
                    <div id="f_trigger_b" class="filter dropdown-Date">
                        <div class="selected">
                            <span class="txt" id="seleDate">5/7/2021</span>
                            <script type="text/javascript">
                                Calendar.setup({
                                    inputField: "seleDate",
                                    ifFormat: "mm/dd/y",
    ...
    <footer class="copyrightOnly">
        <!--start-->
        <div class="copyright">© Copyright 2018. bong88.com. All Rights Reserved.</div>
        <!--end-->
    </footer>
