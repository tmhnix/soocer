...
<div id="TaixiuContainer" class="TaixiuContainer">
  <div class="accountTable">
    <div class="tableHead">
      ...
      <div class="turnover">Cửa đặt</div>
      <div class="credit">Tiền đặt</div>
      <div class="commission">Kết quả</div>
      <div class="balance">Hoàn trả</div>
      <div class="other">Nhận</div>
    </div>
    <div class="tableBody">
    </div>
...
<script>
  ...
  data.forEach((row) => {
    ...
    r += '<div class="turnover">'+ (row.select ? 'Tài' : 'Xỉu') +'</div>';
