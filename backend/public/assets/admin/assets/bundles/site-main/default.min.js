 ...
 * Released under the MIT license
 */
(function (n) { n.fn.resizable = function (t) { var i = n.extend({ direction: ["top", "right", "bottom", "left"] }, t), r = null; return this.each(function () { var e = this, u = n(this), o = !1, t = {}, f = { top: !1, right: !1, bottom: !1, left: !1 }, s = {}, h; if (u.addClass("resizable"), i.direction instanceof Array) for (h = i.direction.length - 1; h >= 0; h--)switch (i.direction[h]) { case "top": case "t": f.top = !0; break; case "right": case "r": f.right = !0; break; case "bottom": case "b": f.bottom = !0; break; case "left": case "l": f.left = !0 } else if (typeof i.direction == "string") switch (i.direction) { case "vertical": case "v": f.top = !0; f.bottom = !0; break; case "horizontal": case "h": f.right = !0; f.left = !0; break; case "top": case "t": f.top = !0; break; case "right": case "r": f.right = !0; break; case "bottom": case "b": f.bottom = !0; break; case "left": case "l": f.left = !0 }f.top && (s.top = n("<div />").addClass("resizable-handle resizable-t").appendTo(u)); f.right && (s.right = n("<div />").addClass("resizable-handle resizable-r").appendTo(u)); f.bottom && (s.bottom = n("<div />").addClass("resizable-handle resizable-b").appendTo(u)); f.left && (s.left = n("<div />").addClass("resizable-handle resizable-l").appendTo(u)); n(this).children(".resizable-l, .resizable-r, .resizable-t, .resizable-b").mousedown(function (f) { r = e; var s; switch (!0) { case n(this).hasClass("resizable-l"): s = "l"; break; case n(this).hasClass("resizable-r"): s = "r"; break; case n(this).hasClass("resizable-t"): s = "t"; break; case n(this).hasClass("resizable-b"): s = "b" }o = !0; t = { x: f.clientX, y: f.clientY, height: u.height(), width: u.width(), direction: s }; n("html").addClass("resizable-resizing resizable-resizing-" + t.direction); r == e && typeof i.start == "function" && i.start.apply(e) }); n(window).mousemove(function (n) { var f, s, h, c; if (o) { f = n.clientX - t.x; s = n.clientY - t.y; switch (t.direction) { case "r": h = t.width + f; h >= i.minWidth && u.width(h); break; case "l": u.width(t.width - f); break; case "b": c = t.height + s; c >= i.minHeight && u.height(c); break; case "t": u.height(t.height - s) }r == e && typeof i.resize == "function" && i.resize.apply(e) } }).mouseup(function () { o = !1; n("html").removeClass("resizable-resizing resizable-resizing-" + t.direction); r == e && typeof i.stop == "function" && i.stop.apply(e); _current = null }); n(this).children(".resizable-l, .resizable-r, .resizable-t, .resizable-b").bind("touchstart", function (f) { var s, h; r = e; switch (!0) { case n(this).hasClass("resizable-l"): s = "l"; break; case n(this).hasClass("resizable-r"): s = "r"; break; case n(this).hasClass("resizable-t"): s = "t"; break; case n(this).hasClass("resizable-b"): s = "b" }o = !0; h = f.originalEvent.touches[0]; t = { x: h.clientX, y: h.clientY, height: u.height(), width: u.width(), direction: s }; n("html").addClass("resizable-resizing resizable-resizing-" + t.direction); r == e && typeof i.start == "function" && i.start.apply(e) }); n(window).bind("touchmove", function (n) { var f, s; if (o) { var h = n.originalEvent.touches[0], c = h.clientX - t.x, l = h.clientY - t.y; switch (t.direction) { case "r": f = t.width + c; f >= i.minWidth && u.width(f); break; case "l": u.width(t.width - c); break; case "b": s = t.height + l; s >= i.minHeight && u.height(s); break; case "t": u.height(t.height - l) }r == e && typeof i.resize == "function" && i.resize.apply(e) } }); n(window).bind("touchend", function () { o = !1; n("html").removeClass("resizable-resizing resizable-resizing-" + t.direction); r == e && typeof i.stop == "function" && i.stop.apply(e); _current = null }) }) } })(jQuery);