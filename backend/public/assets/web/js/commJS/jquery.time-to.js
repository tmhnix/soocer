...
(function (factory) {
    ...
    var dictionary = {
        ...
        ru: { days: 'Ð´Ð½ÐµÐ¹',   hours: 'Ñ‡Ð°ÑÐ¾Ð²',  min: 'Ð¼Ð¸Ð½ÑƒÑ‚',    sec: 'ÑÐµÐºÑƒÐ½Ð´' },
        ua: { days: 'Ð´Ð½iÐ²',   hours: 'Ð³Ð¾Ð´Ð¸Ð½',  min: 'Ñ…Ð²Ð¸Ð»Ð¸Ð½',   sec: 'ÑÐµÐºÑƒÐ½Ð´' },
    ...
    $.fn.timeTo = function () {
        ...
        return this.each(function () {
            ...
            if (!data.vals) {
                ...
                ulhtml = '<ul style="left:' + left + 'px; top:0"><li>0</li><li>0</li></ul></div>';
                style = data.fontSize
    ...
    function tick(digit) {
        ...
        if ($.support.transition) {
            ...
            $ul.stop().animate({ top: '-' + data.height + 'px' }, 400, digit !== data.iSec ? null : function () {
                $li.eq(0).html(n);
                $ul.css({ top: 0 });
